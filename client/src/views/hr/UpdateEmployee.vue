...
export default {
  ...
  setup() {
    ...
    formData.append('employee_gender', employeeData.selectedGender);
    formData.append('employee_title', employeeData.preName);
    formData.append('employee_name', employeeData.name);
    formData.append('employee_surname', employeeData.lastName);
    formData.append('employee_personal_id', employeeData.idCard);
    formData.append('employee_tel', employeeData.phoneNumber);
    formData.append('employee_email', employeeData.email);
    formData.append('employee_birthday', employeeData.birthdate);
    formData.append('employee_address', employeeData.address);
    formData.append('employee_position', employeeData.position);
    formData.append('employee_department', employeeData.department);
    formData.append('employee_start_date', employeeData.startDate);
    formData.append('employee_salary', employeeData.salary);
    formData.append('employee_bank_account', employeeData.idCardBank);
    formData.append('employee_tax_id', employeeData.taxId);
    formData.append('employee_bank_type', 'SCB');
    formData.append('employee_id', employeeData.employeeId);
    formData.append('employee_login_id', employeeData.id);
    formData.append('employee_login_password', employeeData.password);

    // เพิ่มการส่งไฟล์
    formData.append('employee_profile_img', employeeData.employee_profile_img);
    formData.append('employee_personnel_id_img', employeeData.employee_personnel_id_img);
    formData.append('employee_transcript_img', employeeData.employee_transcript_img);
    formData.append('employee_contract', employeeData.employee_contract);
